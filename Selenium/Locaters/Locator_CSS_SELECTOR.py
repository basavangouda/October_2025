...
# driver.get("https://www.saucedemo.com/")
# driver.maximize_window()
# driver.find_element(By.CSS_SELECTOR,"input[name='password']").send_keys("Hello Good Morning")
# time.sleep(5)
# driver.find_element(By.CSS_SELECTOR,"input[class='input_error form_input'][name='password']").clear()
# time.sleep(5)
# driver.close()
#
# #Example 4 find next sibling using of nth type
# driver=webdriver.Chrome()
# driver.get("C://Users//dell//PycharmProjects//2025_PYTHON_SDET_JUNE//Selenium//Locaters//nth-of-type.html")
# driver.maximize_window()
